...
### Not playable without a browser
...
* [record-screen.sh](record-screen.sh)

You can create a virtual camera to share your screen as a webcam even if you are not a presenter in the conference. Due to its low resolution, don't forget to double the font size within each game, text editor and browser tab that you share:
...
* http://identicalsoftware.com/games/
...
* https://appimagehub.com/browse?cat=6
* https://sourceforge.net/software/games/linux/

### Lists with screenshots
...
* https://dosgamesarchive.com/
* https://dosgames.com/
* https://ibiblio.org/pub/micro/pc-stuff/freedos/files/games/
